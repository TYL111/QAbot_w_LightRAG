...
# a107272829
# os.environ["GEMINI_API_KEY"] = "AIzaSyAp6a9tFH-0e6OWdLrnicVTazrlMd6MRfE"
# tyldemail
os.environ["GEMINI_API_KEY"] = "AIzaSyBWik_460-mmsNw8GM4tEfQbazbuuPBJvY"
        ...
        for txt in txts:
            ...
            try:
                ...
                with open(file_path,"r",encoding="utf-8") as f:
                    await rag.ainsert(f.read(),file_path = os.path.join(SOURCE,txt))
                print(f"{txt}處理成功")
